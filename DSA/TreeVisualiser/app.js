...
function treeAndArray(){
    ...
    document.querySelector("#instructions").innerHTML = "Considering the given array as a level-order traversal of a complete binary tree, the following tree can be constructed";
    if(inputText.value !== ''){
...
function heapify(){
    ...
    if(inputText.value !== ''){
        ...
        document.getElementById('instructions').innerHTML = "Parent's value is always greater than or equal to the values of its children";
    }
}
